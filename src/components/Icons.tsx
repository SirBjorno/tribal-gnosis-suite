...
export const TribalGnosisLogo = ({
  ...
  >
    ...
    <path d="M15 12a3 3 0 1 0 5.993.129"></path>
    <path d="M9 12a3 3 0 1 0-5.993.129"></path>
    <path d="M9 12a3 3 0 1 0 5.993.129"></path>
    <path d="M12 19a3 3 0 1 0-5.993.129"></path>
    <path d="M12 19a3 3 0 1 0 5.993.129"></path>
    <path d="M12 5v0a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1v0"></path>
    <path d="M12 12v0a1 1 0 0 0-1 1v2a1 1 0 0 0 1 1v0"></path>
    <path d="m13.5 6.5 1 1"></path>
    <path d="m9.5 6.5-1 1"></path>
    <path d="m13.5 13.5 1 1"></path>
    <path d="m9.5 13.5-1 1"></path>
    <path d="m6.5 10.5-1 1"></path>
    <path d="m18.5 10.5-1 1"></path>
  </svg>
);
...
export const LightbulbIcon = ({ className = 'h-5 w-5' }: { className?: string }) => (
  <svg
    ...
    className={className}
  >
    <path d="M15 14c.2-1 .7-1.7 1.5-2.5C17.7 10.2 18 9 18 8c0-2.2-1.8-4-4-4-1.1 0-2.1.5-2.8 1.2-1.8 1.8-2.2 4.2-.8 6.2"></path>
    <path d="M9 18h6"></path>
    <path d="M10 22h4"></path>
    <path d="M9 14.3c-2.3.9-3.3 3.3-2 5.4.6.9 1.4 1.4 2.3 1.7"></path>
  </svg>
);
