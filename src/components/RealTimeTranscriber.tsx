    ...
    return (
      <div className="bg-white p-6 rounded-xl shadow-lg border border-slate-200/80">
        <div className="bg-amber-100 border-l-4 border-amber-500 text-amber-700 p-4 rounded-md">
          ...
          <p>
            Real-time transcription is not supported in your browser. Please use a modern browser
            like Chrome or Edge.
          </p>
        </div>
      </div>
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-lg border border-slate-200/80">
      ...
      <div className="flex flex-col items-center gap-4">
        ...
        <p className="text-sm font-semibold text-slate-600">
          {isAnalyzing
            ? 'Analyzing...'
            : liveCall
              ? 'Live sync from Microsoft Teams...'
              : isRecording
                ? 'Listening...'
      ...
      <div className="mt-4 bg-slate-100 p-3 border border-slate-200/80 rounded-md min-h-[150px] max-h-64 overflow-y-auto">
        {transcript ? (
          ...
          <p className="text-slate-400">
            {liveCall
              ? 'Waiting for live transcript from Teams...'
      ...
      <button
        ...
        title={
          !isOnline
            ? 'Cannot analyze: internet is offline'
            : isRecording
