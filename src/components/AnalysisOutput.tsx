...
import type { ReviewItem, Analysis, DialogueEntry, DetailedTranscript, CustomerProfile } from '../types';
import { ApproveIcon, RejectIcon, CompareIcon, CloseIcon, ProblemIcon, LightbulbIcon, CustomerProfileIcon } from './Icons';
